...
struct User {
    ...
    var age: Int
        ...
        static var currentUser = User(userName: "sonja", email: "xyz@xyz.com", age: 47)
...
var me = User(userName: "sonja", email: "xyz@xyz.com", age: 47)
User.currentUser = me

var secondUser = User(userName: "gerhard", email: "abc@abc.com", age: 50)
User.logIn(user: me)
