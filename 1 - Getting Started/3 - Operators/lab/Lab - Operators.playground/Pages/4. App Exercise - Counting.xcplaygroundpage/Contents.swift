 ...
 */
var distanceFeet: Double = 50
print("Your distance traveld in feet is:", distanceFeet)

var distanceMeters:Double = distanceFeet / 3.28
print("Your distance traveld in meters is", distanceMeters)
var distanceMeters2 = (distanceMeters * 100).rounded()/100
print("Rouded distance in meters:", distanceMeters2)
