 ...
 */
var myDict = ["January": 31, "February": 28, "March": 31]
print(myDict)
 ...
 */
myDict.updateValue(29, forKey: "February")
print(myDict)
...
let colorsArray = ["Red", "Yellow", "Blue"]

var secondDict = ["Shapes": shapesArray, "Colors": colorsArray]
print(secondDict)
 ...
 */
if let colors = secondDict["Colors"] {
    print(colors.last!)
}

print(secondDict["Colors"]![2])
