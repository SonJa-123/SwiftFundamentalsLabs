...
var favouriteBook = Book(title: "Witches Abroad", author: "Terry Pratchet", pages: 352, price: 18.05)
print(favouriteBook)
 ...
 */
var myHeight = Height(centimeters: 165.1)
print(myHeight.inches)
